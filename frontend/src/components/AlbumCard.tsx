    ...
    <>
      ...
      >
        ...
        {showActions && !isViewingFriend && (
          <div className={`card-action-row grid transition-[grid-template-rows] duration-150 ease-out ${confirmDelete ? 'grid-rows-[1fr]' : 'grid-rows-[0fr] group-hover:grid-rows-[1fr]'}`}>
